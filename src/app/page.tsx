...
export default function Home() {
  return (
    <main
      className={
        "bg-blue-100 min-h-screen px-10 md:px-20 lg:px-20 !scroll-smooth"
      }
    >
      <Hero />
      <section id="Service" className="scroll-behavior: smooth;">
        <div>
          ...
          <p className="text-m py-4 text-gray-600 leading-6">
            With my combined skills as a Full Stack Developer and UI/UX
            Designer, I bring a holistic approach to digital product
            development. I am dedicated to creating solutions that not only meet
            technical requirements but also exceed user expectations in terms of
            usability and aesthetics. My passion for bridge the gap between
        ...
        <div className=" md:flex lg:flex gap-10 mx-auto">
          ...
          <motion.div
            ...
            onHoverStart={(e) => {}}
            onHoverEnd={(e) => {}}
            className="bg-opacity-70 backdrop-blur-lg bg-gray-100 text-center shadow-sm p-5 rounded-xl my-10 shadow-slate-600"
          >
            <img src="/appdev.png " alt="cv" className=" inline w-28 h-28" />
            <h2 className="text-2xl font-bold ">Mobile App Developer</h2>
            <p className="text-sm py-2 text-gray-800 leading-6">
              I am a Mobile App Developer proficient in creating cross-platform
            ...
            <div className=" flex justify-center gap-5 ">
              <img src="/flutternew.png" alt="cv" width={50} height={50} />

              <img src="/android.png " alt="cv" width={50} height={50} />
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-opacity-70 backdrop-blur-lg bg-gray-100 text-center shadow-sm p-5 rounded-xl my-10 shadow-slate-600"
          >
            <img src="/developer.png " alt="cv" className=" inline w-28 h-28" />
          ...
          <motion.div
            ...
            onHoverStart={(e) => {}}
            onHoverEnd={(e) => {}}
            className="bg-opacity-70 backdrop-blur-lg bg-gray-100 text-center shadow-sm p-5 rounded-xl my-10 shadow-slate-600 bg-"
          >
            <img src="/uiux-01.png " alt="cv" className=" inline w-40 h-28" />
            <h2 className="text-2xl font-bold ">UI/UX Developer</h2>
            <p className="text-sm py-2 text-gray-800 leading-6">
              I am a skilled UI/UX Developer with a passion for creating
            ...
            <div className=" flex justify-center gap-5 ">
              <img src="/figma.png " alt="cv" className=" w-14 h-14" />

              <img src="/illust.png" className="w-14 h-14" alt="" />

              <img src="/photoshop.png " alt="cv" className="w-14 h-14" />
            </div>
          </motion.div>
        </div>
      </section>
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  {" "}
                  Angular | ASP .NET | Group | Ongoing{" "}
                </p>
                <p className=" text-sm mb-3  text-gray-200 dark:text-gray-200">
                  Medicare is a Centralized Patient Details System. It is a
          ...
          <div className="basis-1/4 flex-1">
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  NextJS | Tailwind CSS | Individual
                </p>
                <p className=" text-sm mb-3  text-gray-200 dark:text-gray-200">
                  A Responsive Web Application for a personal portfolio Me.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="basis-1/4 flex-1">
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  Flutter | Laravel | Individual | Ongoing
                </p>
                <p className=" text-sm mb-3  text-gray-200 dark:text-gray-200">
                  This is a Mobile application for baby health care Amazing UI
                  things.
                </p>
              </div>
            </motion.div>
          ...
          <div className="basis-1/4 flex-1">
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className=" text-sm mb-3  text-gray-200 dark:text-gray-200">
                  This is a Mobile application for doctor appointment Using
                  Laravel Backend .
                </p>
              </div>
            </motion.div>
          ...
          <div className="basis-1/4 flex-1">
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  Flutter | Firebase | Google API | Individual | Ongoing
                </p>
                <p className=" text-sm mb-3  text-gray-200 dark:text-gray-200">
                  Sri Go is a Comprehensive Travel guide App
                </p>
              </div>
            </motion.div>
          </div>
          <div className="basis-1/4 flex-1">
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  Vite | ReactJS | Individual
                </p>
                <p className=" text-sm mb-3  text-gray-200 dark:text-gray-200">
                  A Responsive Web Application for a personal portfolio for Me.{" "}
                </p>
              </div>
            </motion.div>
          </div>
  ...
  <ActiveSlider/>
      ...
      <section id="contact">
        <footer
          className="border-t-2 border-black text-sm opacity-70
